...
DATA_FOLDER = os.path.join(_SRC_DIR, "data")
...
try:
    from src.utils.db_connection import get_mongodb_connection, PLAYERS_COLLECTION, \
        STATS_EXPLAINED_COLLECTION
    from src.utils.data_loader import normalizar_nombre
...
def run_migration():
    ...
    # Asegúrate que los nombres de archivo coincidan con los que tienes en src/data
...
if __name__ == "__main__":
    ...
    print(
        "Iniciando migración de datos desde CSV a MongoDB (ejecución directa de migrate_to_mongodb.py)...")

    # La lógica de importación al inicio del script ya debería haber
    # configurado sys.path para que 'from src.utils...' funcione.
